...
import { phoneRegExp, emailRegExp, registerNumberRegExp, homePageRegExp } from 'src/utils/common';
...
const CreateTeam = () => {
    ...
    const create = (body) => {
        const businessNumberCheck = registerNumberRegExp(inputs, 'businessNumber', setInputs, setNumberMsg);
